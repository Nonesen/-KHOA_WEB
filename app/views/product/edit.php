        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo BASE_URL; ?>/index.php?url=product/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <?php if (!empty($product->image)): ?>
                                ...
                                <img src="<?php echo htmlspecialchars($product->image); ?>" class="img-thumbnail mb-2" style="max-width: 150px;">
                            <?php else: ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo BASE_URL; ?>/index.php?url=product" class="btn btn-outline-secondary px-4 py-2 rounded-pill">
                                Hủy bỏ
                            </a>
                        </div>
                    </form>
