...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo BASE_URL; ?>/index.php?url=product" class="text-decoration-none text-danger">Trang chủ</a></li>
    ...
    <div class="row bg-white rounded-4 shadow-sm p-4">
        <div class="col-md-5 text-center border-end">
            ...
            $imgSrc = !empty($product->image) ? $product->image : "https://via.placeholder.com/450x450/cccccc/000000?text=No+Image";
            ?>
            <img src="<?php echo htmlspecialchars($imgSrc); ?>"
                class="img-fluid rounded-3"
                style="max-height: 450px; width: 100%; object-fit: contain; background: #f8f9fa; padding: 20px;"
        ...
        <div class="col-md-7 ps-md-5">
            ...
            <div class="d-grid gap-2 d-md-flex mt-5">
                <a href="<?php echo BASE_URL; ?>/index.php?url=product/addToCart/<?php echo $product->id; ?>" class="btn btn-danger btn-lg flex-grow-1 py-3 fw-bold shadow">
                    MUA NGAY <br> <span style="font-size: 0.7rem; font-weight: normal;">(Giao tận nơi hoặc nhận tại cửa hàng)</span>
                </a>
                <a href="<?php echo BASE_URL; ?>/index.php?url=product/addToCart/<?php echo $product->id; ?>" class="btn btn-outline-danger btn-lg px-4 d-flex align-items-center justify-content-center">
    ...
    <div class="mt-5 p-4 bg-white rounded-4 shadow-sm mb-5">
        ...
        <div class="row">
            <div class="col-md-12">
                <p>Sản phẩm <strong><?php echo htmlspecialchars($product->name); ?></strong> được bảo quản ở nhiệt độ lý tưởng...</p>
                <ul>
